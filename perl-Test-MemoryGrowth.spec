...
Version  : 0.03
Release  : 1
URL      : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Test-MemoryGrowth-0.03.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PEVANS/Test-MemoryGrowth-0.03.tar.gz
...
%prep
%setup -q -n Test-MemoryGrowth-0.03
cd %{_builddir}/Test-MemoryGrowth-0.03
...
cp %{_builddir}/Test-MemoryGrowth-0.03/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-MemoryGrowth/ae5457947130c5a7a05fc82ca7baf0570bf57d00
if test -f Makefile.PL; then
...
/usr/share/package-licenses/perl-Test-MemoryGrowth/ae5457947130c5a7a05fc82ca7baf0570bf57d00
